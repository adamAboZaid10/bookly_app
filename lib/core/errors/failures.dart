 ...
 factory ServerFailure.fromDioError(DioError dioError){
  switch (dioError.type)
  {
    ...
    case DioExceptionType.badCertificate:
      return ServerFailure('connection timout with api servers');
    case DioExceptionType.badResponse:
      return ServerFailure.fromRespone(dioError.response!.statusCode, dioError.response!.data);
    case DioExceptionType.cancel:
      return ServerFailure('request to api servers was cancled');
